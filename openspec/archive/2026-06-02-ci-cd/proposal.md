...
| Smoke post-deploy         | Incluido                    | Out                    | Vale el job extra: detecta drift inmediato (e.g. JWT roto, env var faltante). El secret SMOKE*TEST*\* es una sola configuración inicial.                  |
