...
import { PullToRefresh } from '../../features/pwa/components/PullToRefresh.js';
 ...
 * down in normal flow without breaking the desktop sidebar row. `<PullToRefresh />`
 * wraps only `<main>`: the banner is chrome and must not travel with the gesture.
 */
