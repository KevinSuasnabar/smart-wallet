export const t = {
  ...
  transactions: {
    ...
    detailEyebrow: 'Movimiento',
    detailDescriptionLabel: 'Descripción',
    detailNoDescription: 'Sin descripción',
    detailWalletLabel: 'Billetera',
    detailCreatedAtLabel: 'Registrado',
    detailParticipantLabel: 'Participante',
  },
  participants: {
    eyebrow: 'Atribución',
    title: 'Participantes',
    helper:
      'Personas a las que podés atribuir un movimiento. Útil cuando compartís una billetera y querés saber quién hizo cada gasto.',
    createCta: 'Agregar',
    createTitle: 'Agregar participante',
    createSuccess: 'Participante agregado',
    editTitle: 'Editar participante',
    editSuccess: 'Participante actualizado',
    dialogHelper: 'El nombre aparecerá en el selector de cada movimiento.',
    nameLabel: 'Nombre',
    namePlaceholder: 'Ej: Kevin, Ana…',
    colorLabel: 'Color',
    emptyState: 'Todavía no agregaste participantes.',
    deleteDialogTitle: 'Eliminar participante',
    deleteDialogBody:
      'Dejará de aparecer al crear o editar movimientos. Los movimientos que ya tiene atribuidos conservan la atribución.',
    deleteSuccess: 'Participante eliminado',
    // Transaction-side copy
    fieldLabel: 'Participante',
    selectPlaceholder: 'Elegí un participante',
    unattributed: 'Sin atribuir',
    deletedFallback: 'Participante eliminado',
  },
  categories: {
  ...
  settings: {
    ...
    telegram: {
      ...
      linkedDescription: 'Tu cuenta de Telegram ya está vinculada.',
  ...
  budgets: {
    ...
    createEyebrow: 'Crear',
    createSubmit: 'Crear',
    createSuccess: 'Presupuesto creado',
    editTitle: 'Editar presupuesto',
    editEyebrow: 'Editar',
    editSubmit: 'Guardar cambios',
    editNoChanges: 'No hay cambios',
    editSuccess: 'Presupuesto actualizado',
    deleteSuccess: 'Presupuesto eliminado',
    deleteDialogTitle: 'Eliminar presupuesto',
    deleteDialogBody:
      'Esta acción no se puede deshacer. Los movimientos existentes no se verán afectados.',
    deleteDialogConfirm: 'Eliminar',
    notFound: 'Este presupuesto ya no existe',
    emptyState: 'Todavía no tienes presupuestos',
    emptyCta: 'Crear el primero',
    typeLabel: 'Tipo',
    typePerCategory: 'Por categoría',
    typeGlobal: 'Global',
    categoryLabel: 'Categoría',
    currencyLabel: 'Moneda',
    limitLabel: 'Límite mensual',
    rolloverLabel: 'Rollover',
    rolloverHelper: 'El monto no gastado del mes anterior se suma al límite.',
    spentLabel: 'Gastado',
    effectiveLimitLabel: 'Límite efectivo',
    sidebarLabel: 'Presupuestos',
